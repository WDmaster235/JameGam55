...
public class XBowScript : TowerScript
{
    protected override bool TryAct()
    {
        ...
        TowerDefenseGame.Instance.SpawnAllyProjectile(spawnPosition, LaneIndex, GetScaledDamage(), definition.ProjectileSpeed, definition.AccentColor);
        return true;
    }
}
